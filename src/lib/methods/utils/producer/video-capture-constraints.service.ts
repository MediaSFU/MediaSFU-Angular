...
export class VideoCaptureConstraints {
  ...
  QnHDConsPort = QnHDConsPort;
  sdConsPort = sdConsPort;
  hdConsPort = hdConsPort;
  fhdConsPort = fhdConsPort;
  qhdConsPort = qhdConsPort;

  QnHDConsNeu = QnHDConsNeu;
  sdConsNeu = sdConsNeu;
  hdConsNeu = hdConsNeu;
  fhdConsNeu = fhdConsNeu;
  qhdConsNeu = qhdConsNeu;

  QnHDFrameRate = QnHDFrameRate;
  sdFrameRate = sdFrameRate;
  hdFrameRate = hdFrameRate;
  fhdFrameRate = fhdFrameRate;
  qhdFrameRate = qhdFrameRate;

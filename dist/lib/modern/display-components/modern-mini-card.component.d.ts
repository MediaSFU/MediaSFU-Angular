...
export declare class ModernMiniCardComponent implements OnChanges {
    initials: string;
    fontSize: number;
    customStyle: Partial<CSSStyleDeclaration>;
    imageSource: string;

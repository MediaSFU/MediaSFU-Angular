...
import { TranslationSettingsModal, type TranslationChannelAvailability } from '../translation-components/translation-settings-modal/translation-settings-modal.component';
...
import { TranslationReceiveMethods, type TranslationProducerMap, type TranslationRoomConfig } from '../../producers/socket-receive-methods/translation-receive-methods.service';
...
type SidebarPanelContent = 'menu' | 'messages' | 'participants' | 'shareEvent' | 'recording' | 'eventSettings' | 'translation' | 'requests' | 'waiting' | 'coHost' | 'mediaSettings' | 'background' | 'displaySettings' | 'poll' | 'breakoutRooms' | 'configureWhiteboard';
...
export declare class MediasfuGeneric implements OnInit, OnDestroy {
    ...
    liveSubtitleService: LiveSubtitleService;
    translationConsumerSwitch: TranslationConsumerSwitch;
    panelistsUpdated?: PanelistsUpdated;
    panelistFocusChanged?: PanelistFocusChanged;
    receiveControlMedia?: ReceiveControlMedia;
    addedAsPanelist?: AddedAsPanelist;
    removedFromPanelists?: RemovedFromPanelists;
    ...
    protected readonly WhiteboardComponentRef: typeof Whiteboard;
    protected readonly PaginationComponentRef: typeof ModernPaginationComponent;
    protected readonly AudioGridComponentRef: typeof AudioGrid;
    protected readonly FlexibleGridComponentRef: typeof FlexibleGrid;
    ...
    protected readonly ControlButtonsAltComponentRef: typeof ControlButtonsAltComponent;
    protected readonly AlertComponentRef: typeof ModernAlertComponent;
    protected readonly MenuModalComponentRef: typeof ModernMenuModalComponent;
    protected readonly SidebarMenuModalComponentRef: typeof ModernMenuModalComponent;
    protected readonly EventSettingsModalComponentRef: typeof ModernEventSettingsModalComponent;
    protected readonly TranslationSettingsModalComponentRef: typeof TranslationSettingsModal;
    protected readonly RequestsModalComponentRef: typeof ModernRequestsModalComponent;
    protected readonly WaitingRoomModalComponentRef: typeof ModernWaitingRoomModalComponent;
    protected readonly CoHostModalComponentRef: typeof ModernCoHostModalComponent;
    protected readonly MediaSettingsModalComponentRef: typeof ModernMediaSettingsModalComponent;
    ...
    protected readonly DisplaySettingsModalComponentRef: typeof ModernDisplaySettingsModalComponent;
    ...
    protected readonly PollModalComponentRef: typeof ModernPollModalComponent;
    protected readonly BackgroundModalComponentRef: typeof BackgroundModal;
    protected readonly BreakoutRoomsModalComponentRef: typeof BreakoutRoomsModal;
    protected readonly ConfigureWhiteboardModalComponentRef: typeof ConfigureWhiteboardModal;
    protected readonly ScreenboardModalComponentRef: typeof ScreenboardModal;
    protected readonly ScreenboardComponentRef: typeof Screenboard;
    ...
    translationSettingsModalOverrideProps: () => {
        ...
        updateMyDefaultListenLanguage: (value: string | null) => void;
        updateListenPreferences: (value: Map<string, string> | ((prev: Map<string, string>) => Map<string, string>)) => void;
        socket: Socket<import("@socket.io/component-emitter").DefaultEventsMap, import("@socket.io/component-emitter").DefaultEventsMap>;
        roomName: string;
        showAlert: ({ message, type, duration, position, }: {
            message: string;
    ...
    translationSupported: BehaviorSubject<boolean>;
    translationConfig: BehaviorSubject<TranslationRoomConfig>;
    mySpokenLanguage: BehaviorSubject<string>;
    mySpokenLanguageEnabled: BehaviorSubject<boolean>;
    myDefaultOutputLanguage: BehaviorSubject<string>;
    myDefaultListenLanguage: BehaviorSubject<string>;
    listenPreferences: BehaviorSubject<Map<string, string>>;
    translationProducerMap: BehaviorSubject<TranslationProducerMap>;
    activeTranslationProducerIds: Set<string>;
    availableTranslationChannels: BehaviorSubject<Map<string, TranslationChannelAvailability>>;
    participantTranslationStates: BehaviorSubject<Map<string, any>>;
    speakerTranslationStates: BehaviorSubject<Map<string, SpeakerTranslationState>>;
    ...
    alertPosition: BehaviorSubject<"top" | "bottom" | "top-right" | "top-left" | "bottom-right" | "bottom-left" | "center">;
    ...
    isTranslationSettingsModalVisible: BehaviorSubject<boolean>;
    isRequestsModalVisible: BehaviorSubject<boolean>;
    isWaitingModalVisible: BehaviorSubject<boolean>;
    sidebarMessagesTab: BehaviorSubject<"group" | "direct">;
    ...
    activeSidebarContent: BehaviorSubject<SidebarContent>;
    sidebarNavigationStack: BehaviorSubject<SidebarPanelContent[]>;
    modernMenuDarkMode: BehaviorSubject<boolean>;
    ...
    panelists: BehaviorSubject<Participant[]>;
    panelistsFocused: BehaviorSubject<boolean>;
    muteOthersMic: BehaviorSubject<boolean>;
    muteOthersCamera: BehaviorSubject<boolean>;
    permissionConfig: BehaviorSubject<PermissionConfig>;
    ...
    updateShowSubtitlesOnCards: (value: boolean) => void;
    private getShowSubtitlesOnCardsState;
    ...
    private initialControlHeight;
    shouldUseSidebar: () => boolean;
    private isMobileMenuShellActive;
    private isMobileMenuPanelContent;
    mobileMenuShellContent: () => SidebarContent;
    private updateActiveMobileMenuContent;
    isSidebarVisible: () => boolean;
    sidebarWidth: () => number;
    mainScreenWidthFraction: () => number;
    subAspectWidthFraction: () => number;
    private sidebarTitleForContent;
    sidebarTitle: () => string;
    ...
    private prepareSidebarMediaSettings;
    private prepareSidebarContent;
    openSidebarBackground: () => void;
    private openMenuPanelContent;
    private handleSidebarModalVisibility;
    closeSidebar: () => void;
    updateActiveSidebarContent: (content: SidebarPanelContent, pushCurrent?: boolean) => Promise<void>;
    preferredSidebarMessagesTab: () => "group" | "direct";
    updateSidebarMessagesTab: (value: "group" | "direct") => void;
    sidebarDirectMessages: () => Message[];
    sidebarGroupMessages: () => Message[];
    canShowSidebarParticipantList: () => boolean;
    handleSidebarParticipantFilter: (event: Event) => void;
    sidebarNavigateBack: () => void;
    updateIsRecordingModalVisible: (value: boolean) => void;
    updateIsSettingsModalVisible: (value: boolean) => void;
    updateTranslationSupported: (value: boolean) => void;
    updateTranslationConfig: (value: TranslationRoomConfig | null) => void;
    updateMySpokenLanguage: (value: string) => void;
    updateMySpokenLanguageEnabled: (value: boolean) => void;
    updateMyDefaultOutputLanguage: (value: string | null) => void;
    updateMyDefaultListenLanguage: (value: string | null) => void;
    ...
    updateParticipantTranslationState: (memberId: string, state: any) => void;
    updateSpeakerTranslationState: (speakerId: string, outputLanguage: string | null, originalProducerId: string, options?: SpeakerTranslationStateUpdateOptions) => void;
    private syncSpeakerTranslationStatesFromMembers;
    private getTranslationConsumerSwitchParameters;
    private resolveOriginalProducerIdForSpeaker;
    private startConsumingTranslation;
    private pauseTranslatedOriginalsForMembers;
    private pauseOriginalTranslationProducer;
    private resumeOriginalTranslationProducer;
    private stopConsumingTranslationProducer;
    private stopConsumingTranslationSelection;
    private stopConsumingTranslationForSpeaker;
    updateIsTranslationSettingsModalVisible: (value: boolean) => void;
    ...
    updatePanelists: (value: Participant[]) => void;
    updatePanelistsFocused: (value: boolean) => void;
    updateMuteOthersMic: (value: boolean) => void;
    updateMuteOthersCamera: (value: boolean) => void;
    updatePermissionConfig: (value: PermissionConfig) => void;
    ...
    getAllParams(): {
        ...
        updateTranslationSupported: any;
        updateTranslationConfig: any;
        updateMySpokenLanguage: any;
        updateMySpokenLanguageEnabled: any;
        updateMyDefaultOutputLanguage: any;
        updateMyDefaultListenLanguage: any;
        updateListenPreferences: any;
        updateTranslationProducerMap: any;
        updateAvailableTranslationChannels: any;
        updateAutoWave: any;
        updateForceFullDisplay: any;
        updateShowSubtitlesOnCards: any;
        ...
        updateIsTranslationSettingsModalVisible: any;
        ...
        updatePanelists: any;
        updatePanelistsFocused: any;
        updateMuteOthersMic: any;
        updateMuteOthersCamera: any;
        updatePermissionConfig: any;
